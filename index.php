                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a  href="?page=presensi"></i> Presensi</a></li>
                        </ul>
                     </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="?page=presensi&aksi=cetak"></i> Laporan Presensi</a></li>
                     		...
                     		if ($page == "buku") {
                                ...
                                if ($aksi == "") {
                     			...
                     			if ($aksi == "") {
                                    ...
                                    include "page/presensi/tambah.php";
                                }elseif ($aksi == "hapus") {
                                    include "page/presensi/hapus.php";
                                }elseif ($aksi== "cetak") {
                                    include "page/presensi/form_laporan_anggota.php";
                                }
